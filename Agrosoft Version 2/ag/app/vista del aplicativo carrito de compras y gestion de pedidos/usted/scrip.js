...
function mostrarElemtrosLista() {
    ...
    for (let i = 0; i < lista.length; i++){
        productosCompra.innerHTML += `<div><div class="img"><button onclick=eliminar(${i}) class="botonTrash"><img src="/img/botedeBasura.png"></button><p>${lista[i].nombre}</p></div><p> $${lista[i].precio}</p></div>`
